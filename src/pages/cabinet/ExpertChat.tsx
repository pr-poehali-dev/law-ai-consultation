    ...
    >
      ...
      <div className="flex items-center gap-2.5 bg-white rounded-2xl border border-border px-3 sm:px-4 py-3 shadow-sm shrink-0">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[10.5px] font-medium truncate" style={{ color: isAdmin ? "#64748b" : "#059669" }}>
        ...
        <div className="shrink-0 rounded-2xl border border-amber-200/70 overflow-hidden"
          ...
          <div className="flex items-center gap-3 p-3.5">
            ...
            <div>
              ...
              <p className="text-[10.5px] text-amber-700/80">Ответ в течение 1–3 часов</p>
            </div>
          </div>
        </div>
      )}
      ...
      {/* ── СООБЩЕНИЯ ─────────────────────────────────────────────────── */}
      {/*
        КРИТИЧЕСКИ ВАЖНО: flex-1 min-h-0 overflow-y-auto — это единственная
        правильная комбинация для скроллируемого flex-элемента.
        НЕ использовать h-full, НЕ добавлять вложенные div-обёртки.
      */}
      <div
        ref={listRef}
      ...
      >
        {/* Кнопка ↓ Новые — sticky внутри скролла */}
        {showDown && (
          <div className="sticky top-0 flex justify-end z-10 -mt-1 mb-1">
          ...
          <div className="flex flex-col items-center justify-center py-14 gap-4 text-center">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground max-w-[260px]">
                Опишите ситуацию, прикрепите документы или ответ AI
              </p>
            </div>
            {!isAdmin && (
          ...
          <>
            ...
            {isFreeUser && hasSentQ && isBlocked && !hasReply && (
              <div className="flex gap-2.5 items-start animate-fade-in">
                <div className="w-8 h-8 gradient-navy rounded-full flex items-center justify-center shrink-0 shadow-md mt-0.5">
                ...
                <div className="flex-1 max-w-[82%]">
                  ...
                  <div className="rounded-2xl rounded-tl-sm overflow-hidden shadow-sm"
                    ...
                    <div className="p-4">
                      <div className="flex items-center gap-2.5 mb-1.5">
                        <div className="w-7 h-7 rounded-xl flex items-center justify-center" style={{ background: "rgba(232,168,32,.2)" }}>
                  ...
                  <div className="mt-2 bg-white border border-slate-100 rounded-2xl rounded-tl-sm px-3.5 py-3 shadow-sm">
                    ...
                    <button onClick={onUpgradePlan}
                      className="w-full mt-2.5 py-2 rounded-xl text-[11px] font-bold"
                ...
                <div className="rounded-2xl overflow-hidden border border-slate-200 shadow-sm">
                  <div className="px-4 py-3.5" style={{ background: "linear-gradient(135deg,#0f2044,#1a3260)" }}>
                    <div className="flex items-center gap-2.5">
                      ...
                      <div>
                        <p className="text-[13px] font-bold text-white">Тариф «Старт»</p>
                  ...
                  <div className="bg-white px-4 py-3">
                    <div className="grid grid-cols-2 gap-2 mb-3">
                      {[["UserCheck","1 консультация"], ["FileText","5 документов AI"], ["ShieldCheck","Проверка документа"], ["Bot","30 вопросов AI"]].map(([icon, txt]) => (
                    ...
                    <button onClick={onUpgradePlan}
                      className="w-full py-2.5 rounded-xl text-[12px] font-bold mb-1.5"
          ...
          <div className="flex gap-2.5 items-end animate-fade-in">
            ...
            <div className="bg-white border border-slate-100 rounded-2xl rounded-bl-sm px-3.5 py-3 shadow-sm">
              <span className="flex gap-1 items-center">
                {[0, .2, .4].map(d => (
                  <span key={d} className="w-2 h-2 rounded-full bg-navy-400"
        ...
        {isDialogClosed && lmsgs.length > 0 && (
          <div className="flex justify-center py-2">
            <span className="inline-flex items-center gap-1.5 px-4 py-2 rounded-full bg-slate-100 text-[11px] text-slate-500 border border-slate-200">
              <Icon name="Lock" size={11} /> Консультация завершена
            </span>
          </div>
        )}
        ...
        {err && (
          <div className="px-4 pb-3 flex items-center gap-2">
            ...
            <button onClick={onSend} disabled={sending}
              className="flex items-center gap-1 text-[11px] font-bold text-red-600 underline underline-offset-2">
