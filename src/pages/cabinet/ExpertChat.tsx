...
export default function ExpertChat({
  ...
  return (
    ...
    >
      ...
      {/* СООБЩЕНИЯ — flex-1 min-h-0 overflow-y-auto прямо на элементе */}
      <div
        ref={listRef}
        ...
        {!loading && lmsgs.length === 0 && (
          <div className="flex flex-col items-center justify-center py-14 gap-4 text-center">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground max-w-[260px]">Опишите ситуацию, прикрепите документы или ответ AI</p>
            </div>
            {!isAdmin && (
