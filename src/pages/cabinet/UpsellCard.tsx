          ...
          >
            ...
            <div className="relative px-4 py-4">
              ...
              <p className="text-[12.5px] leading-relaxed mb-4" style={{ color: "rgba(255,255,255,0.68)" }}>
                Я ответил на ваш первый вопрос бесплатно — и вижу, что ситуация
                требует более глубокого разбора. Откройте{" "}
                <span style={{ color: "rgba(255,255,255,0.92)", fontWeight: 500 }}>полный доступ</span>
                {" "}к сервису: неограниченные вопросы AI-юристу, готовые документы,
                AI-редактор, калькулятор неустойки и поиск судебной практики —
                всё в одном месте, дешевле разовой консультации юриста.
              </p>
