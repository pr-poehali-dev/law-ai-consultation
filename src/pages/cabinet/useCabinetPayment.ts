...
export const GRANT_LABELS: Partial<Record<ServiceType, string>> = {
  ...
  document:              "+7 запросов к AI активировано",
  ...
  plan_starter:          "Тариф «Старт» активирован — +35 запросов к AI",
  plan_starter_discount: "Тариф «Старт» активирован — +35 запросов к AI",
  plan_pro:              "Тариф «Профи» активирован — +90 запросов к AI, +20 вопросов юристу",
  plan_max:              "Тариф «Максимум» активирован — +200 запросов к AI, +50 вопросов юристу",
  plan_max_expert:       "Тариф «Максимум» активирован — +200 запросов к AI, +50 вопросов юристу",
  plan_corporate:        "Корпоративный тариф активирован — +400 запросов к AI, +50 вопросов юристу",
