...
export const GRANT_LABELS: Partial<Record<ServiceType, string>> = {
  ...
  plan_pro:              "Тариф «Профи» активирован — +100 вопросов, +20 документов, +20 вопросов юристу",
  plan_max:              "Тариф «Максимум» активирован — +300 вопросов, +50 документов, +50 вопросов юристу",
  plan_max_expert:       "Тариф «Максимум» активирован — +300 вопросов, +50 документов, +50 вопросов юристу",
