...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    questions: 100,
    docs: 20,
    features: ["100 вопросов AI-юристу", "20 готовых документов", "Анализ одного документа или фото", "Перспектива дела"],
    popular: true,
    badge: "Хит",
  },
  {
    ...
    questions: 300,
    docs: 50,
    features: ["до 300 вопросов AI-юристу", "50 готовых документов", "Анализ нескольких документов сразу", "Всё из «Профи» + приоритет"],
    popular: false,
    badge: null,
  },
];
