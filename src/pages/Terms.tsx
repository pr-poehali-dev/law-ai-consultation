        ...
        <div className="bg-white rounded-3xl border border-border shadow-sm p-8 md:p-12">
          ...
          <div className="prose prose-sm max-w-none space-y-6 text-navy-700 leading-relaxed">
            ...
            <section>
              ...
              <p>6.1. Контент (тексты, документы, ответы), сгенерированный AI-системой по запросу Пользователя, передаётся ему в пользование для личных и коммерческих целей в рамках оплаченного тарифа.</p>
              <p className="mt-2">6.2. Пользователь самостоятельно несёт ответственность за законность использования сгенерированного контента и обязан проверять его перед практическим применением (см. раздел 7).</p>
              <p className="mt-2">6.3. Исполнитель вправе использовать обезличенные и агрегированные данные о запросах для улучшения качества Сервиса и AI-моделей без возможности идентификации конкретного Пользователя.</p>
              <p className="mt-2">6.4. Пользователь не вправе использовать Сервис и его AI-функции для создания контента, который может причинить вред третьим лицам, нарушает законодательство РФ или используется для автоматизированной массовой рассылки/спама.</p>
            </section>

            <section>
              <h2 className="font-semibold text-navy-800 text-lg mb-3">7. Особенности использования ИИ и ограничения Сервиса</h2>
              <p>Пользователь понимает и безоговорочно принимает, что:</p>
              <ul className="list-disc pl-5 mt-2 space-y-1">
                <li>AI-юрист, генератор и анализатор документов Сервиса работают на основе языковых моделей искусственного интеллекта, ответы которых формируются автоматически и носят исключительно справочный, вспомогательный и информационный характер;</li>
                <li>AI-система может допускать неточности, ошибки, устаревшие сведения о законодательстве, неверную интерпретацию норм права или полностью ошибочные утверждения («галлюцинации»);</li>
                <li>результаты работы AI-системы (в том числе распознавание текста/OCR, анализ и сравнение документов, оценка перспективы дела) не гарантируют точность, полноту или применимость к конкретной ситуации Пользователя;</li>
                <li>Сервис, включая функционал AI, не заменяет квалифицированную юридическую помощь и не является услугой адвоката или практикующего юриста в смысле Федерального закона № 63-ФЗ — для решения сложных, спорных или связанных с высокими рисками правовых ситуаций необходимо обратиться к практикующему юристу или адвокату, в том числе через раздел консультаций живых юристов-экспертов Сервиса;</li>
                <li>Пользователь обязан самостоятельно и критически проверять любые ответы, документы и рекомендации AI-системы, прежде чем использовать их для подачи в суд, государственные органы, контрагентам или иным третьим лицам;</li>
                <li>Исполнитель не несёт ответственности за любые решения, действия, убытки или иные последствия, наступившие для Пользователя или третьих лиц в результате использования ответов AI-системы или сгенерированного контента;</li>
                <li>консультации живых юристов-экспертов также носят характер профессионального мнения по представленным Пользователем сведениям и не гарантируют конкретного исхода дела.</li>
              </ul>
            </section>
