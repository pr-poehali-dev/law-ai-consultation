          ...
          <div className="prose prose-sm max-w-none space-y-6 text-navy-700 leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc pl-5 mt-2 space-y-1">
                ...
                <li><strong>Исполнитель / Администрация</strong> — самозанятый Поварчук Илья Валентинович (ИНН 910403132709);</li>
                ...
                <li><strong>ЮKassa</strong> — платёжный сервис ООО НКО «ЮMoney», используемый для проведения расчётов.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>4.1. Услуги Сервиса оплачиваются через платёжный сервис <strong>ЮKassa</strong> (ООО НКО «ЮMoney»). Доступные способы: банковская карта (Visa, Mastercard, МИР), СБП, ЮMoney и иные способы на странице оплаты.</p>
              <p className="mt-2">4.2. После успешной оплаты ЮKassa формирует и направляет Пользователю электронный чек на указанный email. Исполнитель является самозанятым и применяет НПД — НДС к стоимости услуг не применяется.</p>
              <p className="mt-2">4.3. Данные банковских карт Пользователей Исполнителем не хранятся и не обрабатываются. Все расчёты осуществляются на стороне ЮKassa в соответствии с требованиями PCI DSS.</p>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 mt-2 space-y-1">
                ...
                <li>попытки мошенничества, злоупотребления Сервисом или систем платёжных возвратов (chargeback);</li>
