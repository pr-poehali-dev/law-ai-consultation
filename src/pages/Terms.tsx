          ...
          <div className="prose prose-sm max-w-none space-y-6 text-navy-700 leading-relaxed">
            ...
            <section>
              ...
              <ul className="list-disc pl-5 mt-2 space-y-1">
                ...
                <li><strong>ЮКасса</strong> — платёжный сервис ООО «ЮМани», используемый для проведения расчётов.</li>
              </ul>
            </section>
            ...
            <section>
              ...
              <p>4.1. Услуги Сервиса оплачиваются через платёжный сервис <strong>ЮКасса</strong> (ООО «ЮМани»). Доступные способы: банковская карта (Visa, Mastercard, МИР), СБП, ЮMoney и иные способы на странице оплаты.</p>
              <p className="mt-2">4.2. После успешной оплаты ЮКасса формирует и направляет Пользователю электронный фискальный чек на указанный email в соответствии с требованиями 54-ФЗ. Исполнитель является самозанятым и применяет НПД — НДС к стоимости услуг не применяется.</p>
              <p className="mt-2">4.3. Данные банковских карт Пользователей Исполнителем не хранятся и не обрабатываются. Все расчёты осуществляются на защищённой стороне ЮКасса в соответствии с требованиями PCI DSS.</p>
            ...
            <section>
              ...
              <ul className="list-disc pl-5 mt-2 space-y-1">
                ...
                <li>попытки мошенничества, злоупотребления Сервисом или инициирования необоснованных возвратов через ЮКасса (chargeback);</li>
