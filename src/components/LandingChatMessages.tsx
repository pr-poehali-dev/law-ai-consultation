                ...
                <div className="px-4 py-3.5 space-y-3">
                  <div className="flex gap-2.5 items-start">
                    ...
                    <p className="text-[12.5px] leading-relaxed" style={{ color: "#374151" }}>
                      Всё, что нужно для решения юридических задач — теперь в одном сервисе. Генерация документов, анализ судебной практики, расчет госпошлины и онлайн-редактор — без переключения между вкладками.
                    </p>
                  </div>
                  ...
                  <div className="flex gap-2.5 items-start">
                    ...
                    <p className="text-[12.5px] leading-relaxed" style={{ color: "#374151" }}>
                      Для юристов — мощный инструмент. Для обычных людей — понятный помощник. Хотите убедиться? Попробуйте прямо сейчас!
                    </p>
                  </div>
