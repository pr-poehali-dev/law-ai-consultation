                ...
                <div className="px-4 py-3.5 space-y-3">
                  <div className="flex gap-2.5 items-start">
                    ...
                    <p className="text-[12.5px] leading-relaxed" style={{ color: "#374151" }}>
                      Одно нажатие на кнопку «Создать документ» — и вы в шаге от готового решения. Выберите нужный тип, опишите ситуацию — и AI-помощник подготовит безупречный документ всего за 5 минут. Все возможности сервиса ждут вас в личном кабинете после регистрации.
                    </p>
                  </div>
