...
const FEATURES = [
  { icon: "UserCheck", label: "10 полных консультаций юриста-эксперта", sub: "Личный разбор ситуации, переписка, заключение" },
  { icon: "MessageCircle", label: "150 вопросов AI-юристу", sub: "Консультации по законодательству РФ 24/7" },
  ...
  { icon: "ScanText", label: "Анализ документов AI и юристом", sub: "Юрист изучает ваши документы и даёт оценку" },
  { icon: "Upload", label: "Загрузка файлов для анализа", sub: "PDF, DOCX, фото — AI + юрист изучат детали" },
