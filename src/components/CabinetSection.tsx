...
const WELCOME_MSG = "Добрый день! Меня зовут Правосудик, я AI-юрист, обученный на базе реальных юридических дел. Опишите вашу ситуацию — подготовлю развёрнутый ответ со ссылками на нормативные акты.\n\n*При регистрации вы получите 1 бесплатный вопрос.*";
