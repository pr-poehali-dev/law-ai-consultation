...
const MAX_FEATURES = [
  { text: "Загрузка нескольких файлов сразу (PDF, DOCX, фото)" },
  { text: "Консультация юриста на сайте или по телефону" },
  { text: "Подготовка 2 документов живым юристом" },
  { text: "до 300 вопросов AI-юристу · 50 документов AI" },
  { text: "Приоритетный доступ · Всё включено" },
];

const PRO_FEATURES = [
  { text: "Загрузка файлов в чат — PDF, DOCX, фото" },
  { text: "Анализ документов в диалоге с AI" },
  { text: "100 вопросов AI-юристу · 20 документов" },
