...
const WELCOME_MESSAGE: Message = {
  role: "ai",
  text: "Укажите, какой документ нужен (иск, претензия, договор, возражение и т.п.), и искусственный интеллект подготовит его за 5 минут.\n\nБесплатно — 3 запроса к AI-юристу, обновление лимита каждые 24 часа, загрузка документов.\n\nНачиная с тарифа «Максимум» доступна отправка сгенерированного документа на проверку живому юристу с доступом к чату.\n\nЧем детальнее вы опишете ситуацию — тем качественнее получится документ.",
};
