...
const SERVICE_DETAILS: Record<ServiceType, string> = {
  ...
  document: "7 запросов к AI + AI-редактор, калькулятор неустойки, подсудность",
  ...
  plan_starter: "35 запросов к AI · Генерация .doc · Скачивание в .doc",
  plan_starter_discount: "35 запросов к AI · Генерация .doc · Скидка 50%",
  plan_pro: "90 запросов к AI · Загрузка файлов для анализа в чате · Определение перспективы дела · Генерация .doc",
  plan_max: "200 запросов к AI · Консультация юриста · 2 документа от юриста · Приоритетный доступ",
  plan_max_expert: "200 запросов к AI · Консультация юриста · 2 документа от юриста · Приоритетный доступ",
  ...
  plan_corporate: "400 запросов к AI + 50 вопросов юристу",
