...
VAPID push support: vapid-public-key, push-subscribe, push-subscribe-anon (keys: raw base64url)
"""
import json
import os
import re
...
from auth_handler import (
    ...
    handle_consume_request, handle_refund_request, handle_add_paid_service,
...
def handler(event: dict, context) -> dict:
    ...
    auth_actions = {
        ...
        "consume-request": lambda: handle_consume_request(token),
        "refund-request": lambda: handle_refund_request(token),
